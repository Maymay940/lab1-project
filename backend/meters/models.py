...
class WaterMeter(models.Model):
    ...
    user = models.ForeignKey(
        User, on_delete=models.RESTRICT, related_name="meters", db_column="user_id"
    )
    ...
    last_verified_reading = models.IntegerField(
        "Последние показания", default=0, db_column="last_verified_reading"
    )
...
class Request(models.Model):
    ...
    completed_at = models.DateTimeField(
        "Дата завершения", null=True, blank=True, db_column="completed_at"
    )
